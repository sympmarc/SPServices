...
(function($) {
	...
	$.fn.SPServices.SPCascadeDropdowns = function(options) {
		...
		if(parentSelect.Obj.html() === null && opt.debug) {
			errBox("SPServices.SPCascadeDropdowns", "parentColumn: " + opt.parentColumn, "Column not found on page");
			return;
		}
	...
	$.fn.SPServices.SPDebugXMLHttpResult = function(options) {
		...
		return outString;
	}; // End of function SPDebugXMLHttpResult
	...
	}; // End of function SPGetCurrentUser
	...
	}; // End of function SPLookupAddNew
	...
	$.fn.SPServices.SPGetLastItemId = function(options) {
		...
		return lastId;
	}; // End of function SPGetLastItemId
	...
	$.fn.SPServices.SPGetDisplayFromStatic = function (options) {
		...
		return displayName;
	}; // End of function SPGetDisplayFromStatic
	...
	$.fn.SPServices.SPGetStaticFromDisplay = function (options) {
		...
		return staticName;
	}; // End of function SPGetStaticFromDisplay
	...
	}; // End of function SPRedirectWithID
	...
	$.fn.SPServices.SPSetMultiSelectSizes = function (options) {
		...
		$("#" + cloneId).remove();
	}; // End of function SPSetMultiSelectSizes
	...
	$.fn.SPServices.SPAutocomplete = function (options) {
		...
		var columnObjBackground = $(columnObj).css("background");
