...
(function($) {
	...
	WSops["AddMeeting"]								= [MEETINGS, false];
	WSops["CreateWorkspace"]						= [MEETINGS, false];
	WSops["RemoveMeeting"]							= [MEETINGS, false];
	WSops["SetWorkSpaceTitle"]						= [MEETINGS, false];

	WSops["SearchPrincipals"]						= [PEOPLE, false];

	WSops["AddPermission"]							= [PERMISSIONS, false];
	WSops["AddPermissionCollection"]				= [PERMISSIONS, false];
	WSops["GetPermissionCollection"]				= [PERMISSIONS, false];
	WSops["RemovePermission"]						= [PERMISSIONS, false];
	WSops["RemovePermissionCollection"]				= [PERMISSIONS, false];
	WSops["UpdatePermission"]						= [PERMISSIONS, false];
