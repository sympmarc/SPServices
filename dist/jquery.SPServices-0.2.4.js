/*
 * SPServices 0.2.4 - Work with SharePoint's Web Services using jQuery
 * Version 0.2.4
...
(function($) {
	...
	$.fn.SPServices = function(options) {	
		...
		// as well as to set up the ajaxURL.
		...
		// Each operation requires a different set of values.  This switch statement sets
		// them up for each operation.
	...
	$.fn.SPServices.defaults = {
		...
		pageURL: "",				// [Optional] URL of the page
